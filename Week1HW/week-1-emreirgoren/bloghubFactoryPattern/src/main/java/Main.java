...
public class Main {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        UserService userService = (UserService) factory.createService("user");

        userService.setUserRepository(userRepository);


        BlogService blogService = (BlogService) factory.createService("blog");

        blogService.setBlogRepository(blogRepository);
        ...
        List<String> emailList = userService.getAll()
                .stream()
                .map(User::getEmail)
                .toList();
